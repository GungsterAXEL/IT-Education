...
public class Example_03_Deque {
    public static void main(String[] args) {
        ...
        System.out.println("Первый элемент очереди: " + deque.getFirst()); // Просмотр первого элемента очереди. Если элемент пустой, то выдаст ошибку.
        System.out.println("Последний элемент очереди: " + deque.getLast()); // Просмотр последнего элемента очереди. Если элемент пустой, то выдаст ошибку.
        System.out.println(deque.getClass()); // Узнать класс (class java.util.ArrayDeque) обрабатываемой очереди.
        int i = deque.getFirst(); // Значение элементов очереди можно присвоить в переменную без удаления элементов из очереди. Для метода .getLast() присваивание осуществляется аналогичным образом.
        System.out.println("Результат присваивания в переменную i: " + i);

        System.out.println("Первый элемент очереди: " + deque.peekFirst()); // Просмотр первого элемента очереди. В отличии от метода .getFirst() ошибку не выдаст, а вернёт null.
        System.out.println("Последний элемент очереди: " + deque.peekLast()); // Просмотр последнего элемента очереди. В отличии от метода .getFirst() ошибку не выдаст, а вернёт null.
        System.out.println(deque.peek()); // Просмотр элемента очереди. В отличии от метода .getFirst() ошибку не выдаст, а вернёт null.
        int y = deque.peekFirst(); // Значение элементов очереди можно присвоить в переменную без удаления элементов из очереди и таким образом. Для методов .peek() и .peekLast() присваивание осуществляется аналогичным образом.
