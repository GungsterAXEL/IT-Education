...
TODO:
    Додружить бота с записной книжкой:
        1. Дописать код на создание нужных папок.
        2. Следующий выбор действия в меню возможен только после просмотра записей или выхода в главное меню - подумать как исправить.
        3. Осуществить работу с csv файлами (Импорт и Экспорт).

        4. Основную базу стоит перевести из txt формата в csv:
    ...
    Подружить бота с крестиками-ноликами:
        1. Бот может ходить по несколько раз.
        2. Всё ещё вылезают ошибки выхода за пределы индекса.
