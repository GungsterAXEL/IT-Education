...
count = list(map(str, (i for i in range(len(our_list)) if our_list[i] == u)))
print(f'Второе вхождение строки в список на {count[1]} позиции.' if len(count) > 1 else 'Второго вхождения нет =(')